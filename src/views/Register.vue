...
button:disabled {
	background: rgb(180, 206, 245);
	cursor: default;
}
button:disabled:hover {
	background: rgb(151, 195, 236);
}
...
input:focus,
textarea:focus {
	border-color: rgba(104, 120, 212, 0.3);
	border-width: 0.2em;
	border-radius: 0.5em;
}
...
.loader {
	...
	font-size: 10px;
	position: relative;
	border-top: 0.5em solid rgba(95, 93, 221, 0.2);
	border-right: 0.5em solid rgba(93, 95, 221, 0.2);
	border-bottom: 0.5em solid rgba(93, 117, 221, 0.2);
	border-left: 0.5em solid rgb(93, 144, 221);
